...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  35.3544
    #define DEFAULT_Ki  3.5354
    #define DEFAULT_Kd  88.3860
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 30.0523
  #define DEFAULT_bedKi 5.6917
  #define DEFAULT_bedKd 105.7841
 ...
 */
//M92 X80.0000 Y80.0000 Z400.0000 E413.0000
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 407.29783 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 28, 9, -3.6 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 60, 50, 60, 70 } // (mm) Left, Front, Right, Back insets
